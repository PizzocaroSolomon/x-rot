...
static const double cos_scan_altitude[32] = {
    std::cos(scan_altitude[ 0]), 
    std::cos(scan_altitude[16]),
    std::cos(scan_altitude[ 1]), 
    std::cos(scan_altitude[17]),
    std::cos(scan_altitude[ 2]), 
    std::cos(scan_altitude[18]),
    std::cos(scan_altitude[ 3]), 
    std::cos(scan_altitude[19]),
    std::cos(scan_altitude[ 4]), 
    std::cos(scan_altitude[20]),
    std::cos(scan_altitude[ 5]), 
    std::cos(scan_altitude[21]),
    std::cos(scan_altitude[ 6]), 
    std::cos(scan_altitude[22]),
    std::cos(scan_altitude[ 7]), 
    std::cos(scan_altitude[23]),
    std::cos(scan_altitude[ 8]), 
    std::cos(scan_altitude[24]),
    std::cos(scan_altitude[ 9]), 
    std::cos(scan_altitude[25]),
    std::cos(scan_altitude[10]), 
    std::cos(scan_altitude[26]),
    std::cos(scan_altitude[11]), 
    std::cos(scan_altitude[27]),
    std::cos(scan_altitude[12]), 
    std::cos(scan_altitude[28]),
    std::cos(scan_altitude[13]), 
    std::cos(scan_altitude[29]),
    std::cos(scan_altitude[14]), 
    std::cos(scan_altitude[30]),
    std::cos(scan_altitude[15]), 
    std::cos(scan_altitude[31]),
};

static const double sin_scan_altitude[32] = {
    std::sin(scan_altitude[ 0]), 
    std::sin(scan_altitude[16]),
    std::sin(scan_altitude[ 1]), 
    std::sin(scan_altitude[17]),
    std::sin(scan_altitude[ 2]), 
    std::sin(scan_altitude[18]),
    std::sin(scan_altitude[ 3]), 
    std::sin(scan_altitude[19]),
    std::sin(scan_altitude[ 4]), 
    std::sin(scan_altitude[20]),
    std::sin(scan_altitude[ 5]), 
    std::sin(scan_altitude[21]),
    std::sin(scan_altitude[ 6]), 
    std::sin(scan_altitude[22]),
    std::sin(scan_altitude[ 7]), 
    std::sin(scan_altitude[23]),
    std::sin(scan_altitude[ 8]), 
    std::sin(scan_altitude[24]),
    std::sin(scan_altitude[ 9]), 
    std::sin(scan_altitude[25]),
    std::sin(scan_altitude[10]), 
    std::sin(scan_altitude[26]),
    std::sin(scan_altitude[11]), 
    std::sin(scan_altitude[27]),
    std::sin(scan_altitude[12]), 
    std::sin(scan_altitude[28]),
    std::sin(scan_altitude[13]), 
    std::sin(scan_altitude[29]),
    std::sin(scan_altitude[14]), 
    std::sin(scan_altitude[30]),
    std::sin(scan_altitude[15]), 
    std::sin(scan_altitude[31]),
};
...
private:
    ...
    ros::Time sweep_fpga_time;
    ros::Time sweep_rec_time;
    int layer_num;
